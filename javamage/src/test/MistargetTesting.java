...
public class MistargetTesting {
	...
	public static void main(String[] args) throws Exception {
		...
		// Create a stack to push things onto
		Stack<Oligo> oligoStack	= new Stack<Oligo>();
...
//		}
	...
	private static ArrayList<Oligo> populate( ArrayList<Oligo> pool) throws Exception {
		...
		String genome = FASTA.readFFN(Constants.bo_testing,Oligo.Genome);
...
//		pool.add(Oligo.InsertionFactory(genome, "GTCGATAAGCT", 3599) );2
